...
export class LoginComponent implements OnInit, OnDestroy {
    ...
    constructor(private alertService: AlertService, private toasty: ToastyService, private authService: AuthService, private configurations: ConfigurationService) {
