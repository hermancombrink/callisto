...
module.exports = "<!-- Wrapper-->\r\n<div id=\"wrapper\">\r\n  <ng2-toasty></ng2-toasty>\r\n\r\n  <!-- Navigation -->\r\n  <app-nav-menu style=\"float:left;\"></app-nav-menu>\r\n\r\n  <!-- Page wraper -->\r\n  <div id=\"page-wrapper\" class=\"gray-bg\">\r\n\r\n    <!-- Top Navbar -->\r\n    <app-top-menu></app-top-menu>\r\n\r\n    <!-- Main view  -->\r\n    <router-outlet></router-outlet>\r\n\r\n    <!-- Footer -->\r\n\r\n  </div>\r\n  <!-- End page wrapper-->\r\n  <!-- Right Sidebar -->\r\n\r\n</div>\r\n"
...
var alert_service_1 = __webpack_require__("./src/services/alert.service.ts");
var alertify = __webpack_require__("./src/assets/scripts/alertify.js");
var AppComponent = /** @class */ (function () {
    function AppComponent(toastyService, toastyConfig, alertService) {
...
var fetch_data_component_1 = __webpack_require__("./src/app/fetch-data/fetch-data.component.ts");
var alert_service_1 = __webpack_require__("./src/services/alert.service.ts");
var ng2_toasty_1 = __webpack_require__("./node_modules/ng2-toasty/index.js");
var top_menu_component_1 = __webpack_require__("./src/app/top-menu/top-menu.component.ts");
var authservice_service_1 = __webpack_require__("./src/services/authservice.service.ts");
var iboxtools_module_1 = __webpack_require__("./src/app/iboxtools/iboxtools.module.ts");
var peity_1 = __webpack_require__("./src/directives/peity.ts");
var sparkline_1 = __webpack_require__("./src/directives/sparkline.ts");
var flotChart_1 = __webpack_require__("./src/directives/flotChart.ts");
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            imports: [
                ...
                forms_1.FormsModule,
                iboxtools_module_1.IboxtoolsModule,
                peity_1.PeityModule,
                sparkline_1.SparklineModule,
                flotChart_1.FlotModule,
            ...
            providers: [
                alert_service_1.AlertService, authservice_service_1.AuthserviceService
            ],
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(alertService, toastyService) {
        this.alertService = alertService;
        this.toastyService = toastyService;
    ...
    HomeComponent.prototype.ngOnInit = function () {
        this.alertService.showMessage("Welcome to Callisto", "ERP Management System", alert_service_1.MessageSeverity.info);
    };
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [alert_service_1.AlertService, ng2_toasty_1.ToastyService])
    ], HomeComponent);
...
/***/ "./src/app/iboxtools/iboxtools.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/iboxtools/iboxtools.component.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var IboxtoolsComponent = /** @class */ (function () {
    ...
    IboxtoolsComponent = __decorate([
        core_1.Component({
            selector: 'iboxtools',
            template: __webpack_require__("./src/app/iboxtools/iboxtools.component.html")
        })
    ], IboxtoolsComponent);
...
/***/ "./src/app/iboxtools/iboxtools.module.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var iboxtools_component_1 = __webpack_require__("./src/app/iboxtools/iboxtools.component.ts");
...
module.exports = "<nav class=\"navbar-default navbar-static-side\" role=\"navigation\">\r\n  <div class=\"sidebar-collapse\">\r\n    <ul class=\"nav metismenu\" id=\"side-menu\">\r\n      <li class=\"nav-header\">\r\n        <div class=\"profile-element\" dropdown>\r\n          <img alt=\"image\" class=\"img-circle\" src=\"/images/profile_small.jpg\">\r\n          <a dropdownToggle>\r\n            <span class=\"block m-t-xs\"> <strong class=\"font-bold\">David Williams</strong> </span>\r\n            <span class=\"text-muted text-xs block\">Art Director  </span>\r\n          </a>\r\n        </div>\r\n        <div class=\"logo-element\">\r\n          CA+\r\n        </div>\r\n      </li>\r\n      <li [ngClass]=\"{active: activeRoute('assets')}\">\r\n        <a href=\"#\"><i class=\"fa fa-database\"></i> <span class=\"nav-label\">Asset Register</span> <span class=\"fa arrow\"></span> </a>\r\n        <ul class=\"nav nav-second-level collapse\" [ngClass]=\"{in: activeRoute('assets')}\">\r\n          <li [ngClass]=\"{active: activeRoute('assets/fine')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Find Assets</a></li>\r\n          <li [ngClass]=\"{active: activeRoute('assets/create')}\"><a [routerLink]=\"['/dashboards/dashboard2']\">Register Asset</a></li>\r\n          <li [ngClass]=\"{active: activeRoute('assets/bulk')}\"><a [routerLink]=\"['/dashboards/dashboard2']\">Bulk Register</a></li>\r\n        </ul>\r\n      </li>\r\n      <li [ngClass]=\"{active: activeRoute('workorders')}\">\r\n        <a href=\"#\"><i class=\"fa fa-drivers-license-o\"></i> <span class=\"nav-label\">Work Orders</span> <span class=\"fa arrow\"></span> </a>\r\n        <ul class=\"nav nav-second-level collapse\" [ngClass]=\"{in: activeRoute('workorders')}\">\r\n            <li [ngClass]=\"{active: activeRoute('workorders')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Find Jobs</a></li>\r\n          <li [ngClass]=\"{active: activeRoute('workorders')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Raise Job</a></li>\r\n          <li [ngClass]=\"{active: activeRoute('workorders')}\"><a [routerLink]=\"['/dashboards/dashboard2']\">Close Job</a></li>\r\n          <li [ngClass]=\"{active: activeRoute('workorders')}\"><a [routerLink]=\"['/dashboards/dashboard2']\">Allocate Work</a></li>\r\n        </ul>\r\n      </li>\r\n      <li [ngClass]=\"{active: activeRoute('monitoring')}\">\r\n        <a href=\"#\"><i class=\"fa fa-microchip\"></i> <span class=\"nav-label\">Real Time Monitoring</span> <span class=\"fa arrow\"></span> </a>\r\n        <ul class=\"nav nav-second-level collapse\" [ngClass]=\"{in: activeRoute('dashboards')}\">\r\n            <li [ngClass]=\"{active: activeRoute('monitoring')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Alarms</a></li>\r\n          <li [ngClass]=\"{active: activeRoute('monitoring')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Find Status</a></li>\r\n          <li [ngClass]=\"{active: activeRoute('monitoring')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Create Monitor</a></li>\r\n        </ul>\r\n      </li>\r\n      <li [ngClass]=\"{active: activeRoute('maintanance')}\">\r\n          <a href=\"#\"><i class=\"fa fa-calendar-check-o\"></i> <span class=\"nav-label\">Schedule Maintanance</span> <span class=\"fa arrow\"></span> </a>\r\n          <ul class=\"nav nav-second-level collapse\" [ngClass]=\"{in: activeRoute('dashboards')}\">\r\n              <li [ngClass]=\"{active: activeRoute('maintanance')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Alarms</a></li>\r\n            <li [ngClass]=\"{active: activeRoute('maintanance')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Find Status</a></li>\r\n            <li [ngClass]=\"{active: activeRoute('maintanance')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Create Monitor</a></li>\r\n          </ul>\r\n        </li>\r\n        <li [ngClass]=\"{active: activeRoute('reporting')}\">\r\n            <a href=\"#\"><i class=\"fa fa-users\"></i> <span class=\"nav-label\">Schedule Training</span> <span class=\"fa arrow\"></span> </a>\r\n            <ul class=\"nav nav-second-level collapse\" [ngClass]=\"{in: activeRoute('dashboards')}\">\r\n                <li [ngClass]=\"{active: activeRoute('maintanance')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Alarms</a></li>\r\n              <li [ngClass]=\"{active: activeRoute('maintanance')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Find Status</a></li>\r\n              <li [ngClass]=\"{active: activeRoute('maintanance')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Create Monitor</a></li>\r\n            </ul>\r\n          </li>\r\n        <li [ngClass]=\"{active: activeRoute('reporting')}\">\r\n            <a href=\"#\"><i class=\"fa fa-line-chart\"></i> <span class=\"nav-label\">Reporting</span> <span class=\"fa arrow\"></span> </a>\r\n            <ul class=\"nav nav-second-level collapse\" [ngClass]=\"{in: activeRoute('dashboards')}\">\r\n                <li [ngClass]=\"{active: activeRoute('maintanance')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Alarms</a></li>\r\n              <li [ngClass]=\"{active: activeRoute('maintanance')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Find Status</a></li>\r\n              <li [ngClass]=\"{active: activeRoute('maintanance')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Create Monitor</a></li>\r\n            </ul>\r\n          </li>\r\n          <li [ngClass]=\"{active: activeRoute('reporting')}\">\r\n              <a href=\"#\"><i class=\"fa fa-gear\"></i> <span class=\"nav-label\">Settings</span> <span class=\"fa arrow\"></span> </a>\r\n              <ul class=\"nav nav-second-level collapse\" [ngClass]=\"{in: activeRoute('dashboards')}\">\r\n                  <li [ngClass]=\"{active: activeRoute('maintanance')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Alarms</a></li>\r\n                <li [ngClass]=\"{active: activeRoute('maintanance')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Find Status</a></li>\r\n                <li [ngClass]=\"{active: activeRoute('maintanance')}\"><a [routerLink]=\"['/dashboards/dashboard1']\">Create Monitor</a></li>\r\n              </ul>\r\n            </li>\r\n    </ul>\r\n  </div>\r\n</nav>\r\n"
...
var NavMenuComponent = /** @class */ (function () {
    ...
    NavMenuComponent.prototype.activeRoute = function (routename) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var app_helpers_1 = __webpack_require__("./src/app/app.helpers.ts");
var common_1 = __webpack_require__("./node_modules/@angular/common/esm5/common.js");
var authservice_service_1 = __webpack_require__("./src/services/authservice.service.ts");
var alert_service_1 = __webpack_require__("./src/services/alert.service.ts");
var TopMenuComponent = /** @class */ (function () {
    function TopMenuComponent(authService, alertService, location) {
    ...
    TopMenuComponent.prototype.toggleNavigation = function () {
    ...
    TopMenuComponent.prototype.Logout = function () {
        ...
        this.authService.Logout().subscribe(function (data) {
            ...
            if (error.status === 200) {
                ...
                _this.alertService.showMessage("Error", "Oops something went wrong", alert_service_1.MessageSeverity.error);
            }
        });
    };
    TopMenuComponent = __decorate([
        ...
        __metadata("design:paramtypes", [authservice_service_1.AuthserviceService, alert_service_1.AlertService, common_1.Location])
    ], TopMenuComponent);
...
/***/ "./src/assets/scripts/alertify.js":
/***/ (function(module, exports, __webpack_require__) {
...
__webpack_require__("./src/vendor/flot/jquery.flot.js");
__webpack_require__("./src/vendor/flot/jquery.flot.tooltip.min.js");
__webpack_require__("./src/vendor/flot/jquery.flot.spline.js");
__webpack_require__("./src/vendor/flot/jquery.flot.time.js");
...
__webpack_require__("./node_modules/peity/jquery.peity.js");
...
var utilities_1 = __webpack_require__("./src/services/utilities.ts");
...
/***/ "./src/vendor/flot/jquery.flot.tooltip.min.js":
/***/ (function(module, exports) {
